  ...
  return (
    <footer className="w-full border-t border-white/[0.05] bg-primary/60 backdrop-blur-xl">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-sans text-text-secondary text-sm leading-relaxed font-light max-w-xs">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="mt-2 inline-flex items-center gap-2 px-4 py-2.5 bg-white/5 border border-white/10 rounded-full text-white text-xs font-sans font-medium hover:border-white/30 hover:bg-white/10 transition-all duration-300 w-fit"
              >
                View Resume →
              </motion.a>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
        <p className="font-sans text-text-secondary text-xs flex items-center gap-1.5">
          © {currentYear} {DEVELOPER_INFO.name}. Built with
          <FaHeart size={10} className="text-red-400 animate-pulse" />
